...
const OverallROICard = () => {
  const overallROI = '3.4x';
  const percentageChange = 12;
  const progress = 80; // Example progress
  const gradient = ['#FBBF24', '#34D399', '#3B82F6'];

  return (
    <MainCard title="Overall ROI" className="h-36">
      <div className="flex flex-col justify-end h-full">
        <div className="flex justify-between items-center mb-2">
          <p className="text-white text-3xl font-bold">{overallROI}</p>
